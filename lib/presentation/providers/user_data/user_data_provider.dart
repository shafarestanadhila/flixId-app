...
import 'package:flix_id_app/domain/usecases/get_logged_in_user/get_logged_in_user.dart';
import 'package:flix_id_app/domain/usecases/login/login.dart';
...
import 'package:flix_id_app/domain/usecases/top_up/top_up.dart';
import 'package:flix_id_app/domain/usecases/top_up/top_up_param.dart';
import 'package:flix_id_app/domain/usecases/upload_profile_picture/upload_profile_picture.dart';
...
import 'package:flix_id_app/presentation/providers/transaction_data/transaction_data_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/get_logged_in_user_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/login_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/logout_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/register_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/top_up_provider.dart';
import 'package:flix_id_app/presentation/providers/usecase/upload_profile_picture_provider.dart';
...
class UserData extends _$UserData {
  ...
  Future<void> register({required String email, required String password, required String name, String? imageUrl}) async {
    ...
    var result = await register(RegisterParams(name: name, email: email, password: password, photoUrl: imageUrl));
  ...
  Future<void> topUp(int amount) async {
    ...
    if(userId != null){
      ...
      if(result.isSuccess){
        refreshUserData();
        ref.read(transactionDataProvider.notifier).refreshTransactionsData();
      }
    }
  }
  ...
  Future<void> uploadProfilePicture({required User user, required File imageFile}) async {
    ...
    var result = await uploadProfilePicture(UploadProfilePictureParam(imageFile: imageFile, user: user));
